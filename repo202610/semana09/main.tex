...
\begin{frame}{Computational complexity}
	...
	\bigskip
	\begin{itemize}
		\item We've used notation such as $O$ and $\Omega$ to describe the
			worst-case complexity of \emph{algorithms}.\pause
		\item[]
		\item We must now turn to the complexity of
			\emph{computational problems}. 
	\end{itemize}
\end{frame}
...
\begin{frame}{Computational complexity --- \emph{Church-Turing thesis and models of computation}}
	...
	\begin{itemize}
		...
		\item RAM instructions \checkmark (Every other course)\pause
	...
	\bigskip
	\pause
	The \textbf{Church-Turing thesis} says that any two of these models are
	equivalent.
\end{frame}
...
\begin{frame}{RAM instructions model of computation}
	\begin{itemize}
		\item Our discussion of computational complexity and intractability
			will be in terms of the \emph{RAM} model of computation. 
		\item[]\pause
		\item We will use a \textbf{fixed programming language \underline{with types}},
			very Java-like.\pause
		\item[]
...
\begin{frame}{Computable decision problems - Complexity classes}
	This primality test is based on Erathosthenes' theorem.
